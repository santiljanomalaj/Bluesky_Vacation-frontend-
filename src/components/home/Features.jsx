...
import 'assets/styles/home/feature.scss'

const Features = props => (
  <section className="features pt-0 pb-45 mb-0">
                ...
                <div className="grid-ibx__row clearfix d-flex flex-column flex-md-row">
                  <div className="grid-ibx__item h-300">
                    <div className="grid-ibx__item-inner">
                      ...
                      <div className="grid-ibx__icon-wrp">
                        <img className="popularone" src='https://res.cloudinary.com/vacation-rentals/image/upload/v1553978125/images/vc_rj_1.webp' width="70" height="70" alt="" />
                      </div>
                  ...
                  <div className="grid-ibx__item h-300">
                    <div className="grid-ibx__item-inner">
                      ...
                      <div className="grid-ibx__icon-wrp">
                        <img className="populartwo" src='https://res.cloudinary.com/vacation-rentals/image/upload/v1553978138/images/vc_rj_3.webp' width="70" height="70" alt="" />
                      </div>
                      <div className="grid-ibx__desc-wrp">
                        <p className="grid-ibx__desc fs-16">
                  ...
                  <div className="grid-ibx__item h-300">
                    <div className="grid-ibx__item-inner">
                      ...
                      <div className="grid-ibx__icon-wrp">
                        <img className="popularthree" src='https://res.cloudinary.com/vacation-rentals/image/upload/v1553978147/images/vc_rj_6.webp' width="70" height="70" alt="" />
                      </div>
                      <div className="grid-ibx__desc-wrp">
                        <p className="grid-ibx__desc fs-16">
                ...
                <div className="grid-ibx__row clearfix d-flex flex-column flex-md-row">
                  <div className="grid-ibx__item h-300">
                    <div className="grid-ibx__item-inner">
                      ...
                      <div className="grid-ibx__icon-wrp">
                        <img className="popularfour" src='https://res.cloudinary.com/vacation-rentals/image/upload/v1553978159/images/vc_rj_2.webp' width="70" height="70" alt="" />
                      </div>
                      <div className="grid-ibx__desc-wrp">
                        <p className="grid-ibx__desc fs-16">
                  ...
                  <div className="grid-ibx__item h-300">
                    <div className="grid-ibx__item-inner">
                      ...
                      <div className="grid-ibx__icon-wrp">
                        <img className="popularfive" src='https://res.cloudinary.com/vacation-rentals/image/upload/v1553978166/images/vc_rj_5.webp' width="70" height="70" alt="" />
                      </div>
                      <div className="grid-ibx__desc-wrp">
                        <p className="grid-ibx__desc fs-16">
                  ...
                  <div className="grid-ibx__item h-300">
                    <div className="grid-ibx__item-inner">
                      ...
                      <div className="grid-ibx__icon-wrp">
                        <img className="popularsix" src='https://res.cloudinary.com/vacation-rentals/image/upload/v1553978173/images/vc_rj_4.webp' width="70" height="70" alt="" />
                      </div>
                      <div className="grid-ibx__desc-wrp">
                        <p className="grid-ibx__desc fs-16">
                          We never charge travelers for making a reservation through our site. All expenses are paid by the listing owner with nothing else due.
                          <span className="d-block">
                            <a href="{{ url('united-states') }}" title="Book with confidence and enjoy your vacation.">Book with confidence and enjoy your vacation.
                            </a>
                          </span>
                        </p>
                      </div>
