          ...
          <div className="row flex-container">
              ...
              <a href="#">
                <div className="host-area cenralize">
                  <div className="host-container h-260">
                    <img src="https://res.cloudinary.com/vacation-rentals/image/upload/c_fill,fl_lossy,q_auto:low,w_auto/v1555703148/images/booking_1.webp"   alt="" />
            ...
            <div className="col-md-4">
              <a href="#">
                <div className="host-area cenralize">
                  <div className="host-container h-260">
                    <img src="https://res.cloudinary.com/vacation-rentals/image/upload/c_fill,fl_lossy,q_auto:low,w_auto/v1555703149/images/booking_2.webp"  alt="" />
                    <div className="image-shadow" />
                  </div>
