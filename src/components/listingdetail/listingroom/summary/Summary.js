...
import 'assets/styles/pages/homes/summary.scss';
    ...
    return (
      <div id="summary" className="panel col-lg-8 col-sm-12 room-section">
        <RoomFeedback
          ...
          room_name={this.props.room_detail ? this.props.room_detail.name : ""}
          address={
            this.props.room_detail
              ? this.props.room_detail.rooms_address
                ? this.props.room_detail.rooms_address
                : {}
              : {}
          }
        ...
        />
        <RoomVideo
          video_url={this.props.room_detail ? this.props.room_detail.video : ""}
        />
