          ...
          <td
            className={`  
              ...
              ${
                ...
                this.props.calendar_data.unavailable_dates.indexOf(
                  dateFns.format(day, dateFormat_1)
                ) !== -1
                  ? "booked " +
                    this.props.calendar_data.day_types[
                      this.props.calendar_data.unavailable_dates.indexOf(
                        dateFns.format(day, dateFormat_1)
                      )
                    ] +
                    " " +
                    this.props.calendar_data.day_position[
                      this.props.calendar_data.unavailable_dates.indexOf(
                        dateFns.format(day, dateFormat_1)
                      )
                    ] +
