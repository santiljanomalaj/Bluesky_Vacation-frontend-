            ...
            <div className="panel-body">
              <div className="row d-lg-flex align-items-center mb-3">
                ...
                <div className="col-12 col-md-4 align-items-center">
                  <button
                    type="button"
                    id="review-listing-btn"
                    className="btn btn-block btn-primary btn-md"
                    onClick={this.onOpenModal}
                  >
                    <span>
                      <i className="glyphicon-bullhorn" />
                      Leave a Review
                    </span>
                  </button>
                </div>
                            ...
                            <div className="row review">
                              <div className="col-md-3 col-sm-12 text-center space-2 lang-chang-label">
                                <div className="media-photo-badge">
                                  <a
                                    className="media-photo media-round"
                                    href="#"
                                  >
                                    <img
                                      width={67}
                                ...
                                <div className="name">
                                  <a
                                    target="_blank"
                                    className="text-muted link-reset"
                                    href="#"
                                  >
                              ...
                              <div className="col-md-9 col-sm-12">
                                <div className="space-2">
                                  ...
                                  <div className="text-muted review-subtext">
                                    <div className="review-translation-language"></div>
                                    <div>
          ...
          <div className="row d-lg-flex flex-md-column flex-lg-row">
            <div className="col-lg-5 d-flex flex-basis-40 p-0">
              <div id="review_form_wizard_left_form" className="left_form">
                <figure>
                  <img src="https://www.vacation.rentals/images/icons/review_bg.svg" />
                </figure>
                <h2>Write a Review</h2>
                <p>
                  An honest review will help your host provide a better
                  experience, and it will help travelers when they’re selecting
                  a place to stay.
                </p>
                <a
