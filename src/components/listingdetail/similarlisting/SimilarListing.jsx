...
import 'assets/styles/pages/homes/similarlisting.scss';
      ...
      return (
        <div className="listing list_view " key={listing.id}>
          <div className="panel-image listing-img">
            <a
              href={`/homes/${listing.address_url}/${listing.id}`}
              target="_blank"
            ...
            >
              <div className="listing-img-container media-cover text-center">
                <img
                  id="rooms_image_10968"
                  src={listing.slide_image_name}
          ...
          <div className="panel-body panel-card-section">
            <div className="media">
              ...
              <div
                ...
                className="pull-left text-muted listing-location text-truncate nt_star"
              >
                <Link to="#" className="text-normal link-reset pull-left">
            ...
            >
              <h3
                title={listing.name}
                itemProp="name"
                className="h5 listing-name text-truncate row-space-top-1"
              >
                {listing.name}
              </h3>
            </a>
            <div className="exp_price">
              <strong>
                {listing.rooms_price.currency_code === "USD"
                  ? "$"
                  : listing.rooms_price.currency_code}
                {listing.rooms_price.night}
              </strong>
      ...
      <div id="similar-listings">
        <div className="page-container-responsive row-space-top-5 row-space-5">
          <div className="col-md-12 col-sm-12 col-xs-12 col-lg-12">
            <h4 className="row-space-4 text-center-sm">Similar Listings</h4>
            <div className="slider1 owl-carousel slide1 owl-loaded owl-drag">
              <div>
                {slide_list.length ? (
                  <Slider {...settings}>{slide_list}</Slider>
                ) : (
                  <div></div>
                )}
              </div>
