    ...
    return (
      <form className="ng-pristine ng-valid ng-valid-maxlength">
        <div className="js-section list_hover">
          ...
          />
          <Propertyeditor
            value={this.props.data.summary ? this.props.data.summary : ""}
            name="summary"
            onChange={this.props.handleChangeSummary}
          />
        </div>
        <div className="js-section list_hover">
          <h4 className="row-space-top-0 row-space-1">The Space</h4>
          <Guesteditor
            value={this.props.data.room_description ? this.props.data.room_description.access : ""}
            name="access"
            onChange={this.props.onDescriptionChange}
          />
          <Interactioneditor
            value={this.props.data.room_description ? this.props.data.room_description.interaction : ""}
            name="interaction"
            onChange={this.props.onDescriptionChange}
          />
          <Othereditor
            value={this.props.data.room_description ? this.props.data.room_description.notes : ""}
            name="notes"
            onChange={this.props.onDescriptionChange}
          />
          <Houseeditor
            value={this.props.data.room_description ? this.props.data.room_description.house_rules : ""}
            name="house_rules"
            onChange={this.props.onDescriptionChange}
          />
        </div>
        ...
        <div className="js-section list_hover col-sm-12">
          ...
          <Overvieweditor
            value={this.props.data.room_description ? this.props.data.room_description.neighborhood_overview : ""}
            name="neighborhood_overview"
            onChange={this.props.onDescriptionChange}
          />
          <Gettingeditor
            value={this.props.data.room_description ? this.props.data.room_description.transit : ""}
            name="transit"
            onChange={this.props.onDescriptionChange}
          />
        </div>
