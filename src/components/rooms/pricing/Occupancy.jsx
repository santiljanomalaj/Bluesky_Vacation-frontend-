    ...
    return (
      <div className="base_priceamt">
        ...
        <div className="base_text" id="guest_charge_wrapper">
          <div className="col-xl-4 col-lg-12 base_amut bottom_space mb-3">
            <label className="h6">
              Number of Max Occupants
              <i
                rel="tooltip"
                className="icon icon-question"
                title="The total number of guests your listing is able to accomodate."
              />
            </label>
          ...
          <div className="col-xl-4 col-lg-12 base_amut bottom_space mb-3">
            <label className="h6">
              ...
              <i
                rel="tooltip"
                className="icon icon-question"
                title="The base number of guests allowed during a reservation before additional guest charges are applied."
              />
            </label>
            <div className="base_pric">
              <input
          ...
          <div className="col-xl-4 col-lg-12 base_amut bottom_space mb-3">
            ...
            <div className="base_pric">
              <div className="base_pric">
                <div className="price_doller input-prefix">
                  {this.props.code}
                </div>
                <input
                  type="number"
                  ...
                  limit-to={9}
                  data-extras="true"
                  id="price-additional_guest"
                  value={this.props.additional_guest}
                  onChange={this.props.onChange}
