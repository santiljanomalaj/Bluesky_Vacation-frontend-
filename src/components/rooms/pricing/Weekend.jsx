          ...
          <div className=" col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 base_amut bottom_space">
            <label className="h6">
              ...
              <i
                ...
                title="Rate charged for weekend reservations.  Please note, if a reservation includes both a weekday & weekend your listing rate will be displayed as an average of the base nightly rate and the weekend rate."
              />
            </label>
