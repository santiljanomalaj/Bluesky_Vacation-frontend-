...
class Submenu extends React.Component {
  ...
  componentDidMount() {
    roomsService.getStepstatus(this.props.room_id).then(res => {
      if (res) {
        this.setState({
          rooms_step_status: res
        });
      } else {
        alertService.showError('Get Room Step status');
      }
    });
    roomsService.getBasicsData(this.props.room_id).then(res => {
      if (res) {
        this.setState({
          page_data: res.result
        });
      } else {
        alertService.showError('Get Basic Data');
      }
    });
  }
